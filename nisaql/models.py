...
class AntenatalAssessment(models.Model):
    ...
    fetal_lie = models.CharField(max_length=12, blank=True, null=True)
...
class AntenatalPackageItem(models.Model):
...
class AppointmentClinic(models.Model):
    ...
    queue_type = models.CharField(max_length=75, blank=True, null=True)
...
class AttachmentCategory(models.Model):
    ...
    role_ids = models.CharField(max_length=200, blank=True, null=True)
...
class AuthorizationCode(models.Model):
    ...
    channel_address = models.CharField(max_length=50, blank=True, null=True)
...
class Bed(models.Model):
    ...
    room = models.ForeignKey('Room', models.DO_NOTHING, db_column='room_id') #models.IntegerField()
...
class Bills(models.Model):
    ...
    amount = models.DecimalField(max_digits=10, decimal_places=2)
    copay = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
...
class ClinicalTaskCombo(models.Model):
    name = models.CharField(max_length=50)
    create_user_id = models.IntegerField()
    create_time = models.DateTimeField()
...
class ClinicalTaskComboData(models.Model):
    ...
    class Meta:
        ...
        unique_together = (('clinical_task_combo_id', 'type'),)
...
class Death(models.Model):
    cert_number = models.CharField(max_length=25, blank=True, null=True)
...
class DentologyTemplate(models.Model):
    label = models.CharField(max_length=50)

    class Meta:
        managed = False
        db_table = 'dentology_template'


class DentologyTemplateData(models.Model):
    dentology_template_id = models.IntegerField()
    label = models.CharField(max_length=32)
    reference = models.CharField(max_length=128)

    class Meta:
        managed = False
        db_table = 'dentology_template_data'


class Departments(models.Model):
    name = models.CharField(max_length=50)
    cost_centre = models.ForeignKey('CostCentre', models.DO_NOTHING, db_column='cost_centre_id')#models.IntegerField()
...
class EncounterForm(models.Model):
    encounter_id = models.IntegerField()
    ...
    class Meta:
        ...
        unique_together = (('encounter_id', 'form_id'),)
...
class FakePatient(models.Model):
    ...
    country = models.ForeignKey(Countries, models.DO_NOTHING, related_name="district", blank=True, null=True)
    ...
    lga = models.ForeignKey('Lga', models.DO_NOTHING, related_name="lga", blank=True, null=True)
    ...
    res_state = models.ForeignKey('State', models.DO_NOTHING, related_name="res_state", blank=True, null=True)
    state = models.ForeignKey('State', models.DO_NOTHING, related_name="state", blank=True, null=True)
    res_lga = models.ForeignKey('Lga', models.DO_NOTHING, related_name="res_lga", blank=True, null=True)
    res_dist = models.ForeignKey(District, models.DO_NOTHING, related_name="res_district", blank=True, null=True)
...
class Insurance(models.Model):
    active = models.IntegerField()
    patient = models.OneToOneField('PatientDemograph', models.DO_NOTHING, unique=True)
    scheme = models.ForeignKey('InsuranceSchemes', models.DO_NOTHING, db_column='insurance_scheme', blank=True, null=True)
...
class Item(models.Model):
    ...
    billing_code = models.CharField(max_length=10)
    description = models.CharField(max_length=512, blank=True, null=True)
    erp_product_id = models.CharField(max_length=50, blank=True, null=True)
...
class ItemGeneric(models.Model):
    name = models.CharField(max_length=50)
    category_id = models.IntegerField(blank=True, null=True)
    description = models.TextField(blank=True, null=True)
...
class ItemGenericData(models.Model):
...
class ItemGroupSc(models.Model):
...
class LabResultData(models.Model):
    lab_result = models.ForeignKey(LabResult, models.DO_NOTHING, primary_key=True)
...
class OphthalmologyResultData(models.Model):
    ophthalmology_result_id = models.IntegerField(primary_key=True)
...
class PatientItemRequest(models.Model):
    patient_id = models.IntegerField()
...
class PatientItemRequestData(models.Model):
    ...
    cancelled_note = models.CharField(max_length=500, blank=True, null=True)
...
class PatientProcedure(models.Model):
    patient = models.ForeignKey('PatientDemograph', models.DO_NOTHING, db_column='patient_id') #models.IntegerField()
    in_patient_id = models.IntegerField(blank=True, null=True)
    procedure = models.ForeignKey('Procedure', models.DO_NOTHING, db_column='procedure_id') #models.IntegerField()
    ...
    source_instance_id = models.IntegerField(blank=True, null=True)
    scheduled_resource_ids = models.CharField(max_length=120, blank=True, null=True)
...
class PatientProcedureNote(models.Model):
    patient_procedure = models.ForeignKey('PatientProcedure', models.DO_NOTHING, db_column='patient_procedure_id') #models.IntegerField()
    note = models.TextField(blank=True, null=True)
    staff_id = models.IntegerField()
...
class PatientRegimens(models.Model):
    ...
    requested_by = models.IntegerField(blank=True, null=True)
    prescribed_by = models.CharField(max_length=50, blank=True, null=True)
    service_centre_id = models.IntegerField(blank=True, null=True)
    in_patient_id = models.IntegerField(blank=True, null=True)
    note = models.TextField(blank=True, null=True)
    hospid = models.IntegerField(blank=True, null=True)
...
class PatientVitalPreference(models.Model):
    patient_id = models.IntegerField()
    type = models.CharField(max_length=50)
    ...
    class Meta:
        ...
        unique_together = (('patient_id', 'type'),)


class PaymentMethods(models.Model):
    name = models.CharField(max_length=20)
    type = models.CharField(max_length=33)
    ledger_id = models.CharField(max_length=50, blank=True, null=True)
    hospid = models.IntegerField()
...
class Procedure(models.Model):
    name = models.CharField(max_length=100)
    category = models.ForeignKey('ProcedureCategory', models.DO_NOTHING, db_column='category_id') #models.IntegerField()
    billing_code = models.CharField(max_length=10)
...
class ProcedureResourceType(models.Model):
    name = models.CharField(max_length=50)
...
class ProcedureSpecialty(models.Model):
...
class Resource(models.Model):
    ...
    modality = models.CharField(max_length=2, blank=True, null=True)
...
class Room(models.Model):
    name = models.CharField(max_length=30)
    ward = models.ForeignKey('Ward', models.DO_NOTHING, db_column='ward_id')#models.IntegerField()
    room_type = models.ForeignKey('RoomType', models.DO_NOTHING, db_column='type_id')#models.IntegerField()
...
class SformAnswer(models.Model):
    patient_id = models.IntegerField()
    encounter_id = models.IntegerField(blank=True, null=True)
    ...
    class Meta:
        ...
        unique_together = (('encounter_id', 'question_id'),)


class SformAnswerOption(models.Model):
...
class SformCategory(models.Model):
    name = models.CharField(max_length=50)
...
class SformOption(models.Model):
...
class SformQuestion(models.Model):
...
class StaffDirectory(models.Model):
    ...
    profession = models.CharField(max_length=18, blank=True, null=True)
